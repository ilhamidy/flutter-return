    ...
    return Scaffold(
      body: Center(
        child: GestureDetector(
          onTap: () => log("gambar di klik 1 kali"),
          onTapCancel: () => log("gambar gagal di klik 1 kali"),
          onLongPress: () => log("gambar di kilk lama"),
          onLongPressCancel: () => log("gambar gagal di klik lama"),
